...
| Prompt | Cost | Entropy | **0.23.1** | **0.23.0** | **0.22.0** | **0.21.1** | **0.21.0** |
|---|---|---|---|---|---|---|---|
| **bump-semver-version** | $$$ | 7.33 | 422 | 422 | 422 <sub>🔴 +1</sub> | 421 | 421 |
| **commit** | $$ | 6.99 | 365 <sub>🔴 +41</sub> | 324 | 324 <sub>🟢 -1</sub> | 325 | 325 |
| **create-mr** | $$ | 6.93 | 272 | 272 | 272 | 272 | 272 |
| **create-pr** | $$$ | 7.18 | 403 | 403 | 403 | 403 | 403 |
| **create-source-map** | $$ | 7.06 | 332 | 332 | 332 | 332 | 332 |
| **debug** | $$ | 6.95 | 340 <sub>🔴 +12</sub> | 328 <sub>🔴 +11</sub> | 317 | 317 | 317 |
| **fix-mr** | $$ | 6.55 | 202 | 202 | 202 | 202 | 202 |
| **fix-pr** | $$ | 6.97 | 275 | 275 | 275 | 275 | 275 |
| **improve-prompt** | $$ | 6.80 | 350 | 350 | 350 <sub>🟢 -2</sub> | 352 | 352 |
| **optimize-prompt** | $$$$$$ | 7.84 | 1172 | 1172 | 1172 <sub>🔴 +150</sub> | 1022 | 1022 |
| **plan-shipping** | $$ | 6.53 | 371 | 371 | 371 | 371 | 371 |
| **read-source-map** | $$ | 7.04 | 306 | 306 | 306 <sub>🟢 -2</sub> | 308 | 308 |
| **review-mr** | $$ | 6.68 | 228 | 228 | 228 | 228 | 228 |
| **review-pr** | $$$ | 7.54 | 480 | 480 <sub>🔴 +199</sub> | 281 <sub>🟢 -1</sub> | 282 | 282 |
| **ship-gh-issue** | $$$ | 7.22 | 511 <sub>🔴 +45</sub> | 466 <sub>🔴 +11</sub> | 455 | - | - |
| **ship** | $$ | 6.63 | 244 | 244 | 244 <sub>🟢 -225</sub> | 469 | 469 |
| **squash** | $ | 6.55 | 180 | 180 | 180 | 180 | 180 |
| **suggest-better-function-names** | $$ | 6.92 | 303 | 303 | 303 | 303 | 303 |
| **TOTAL** |  |  | **6756** <sub>🔴 +98</sub> | **6658** <sub>🔴 +221</sub> | **6437** <sub>🔴 +375</sub> | **6062** | **6062** |
