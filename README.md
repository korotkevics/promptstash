...
| Prompt | **0.13.1** | **0.12.1** | **0.12.0** | **0.11.0** | **0.9.3** |
|---|---|---|---|---|---|
| **bump-semver-version** | 864 | 864 | 864 | 864 | - |
| **commit** | 286 | 286 | 286 | 286 | 286 |
| **create-pr** | 490 | 490 | 490 | 490 | 490 |
| **create-simple-source-map** | 505 <sub>🟢 -201</sub> | 706 | 706 <sub>🔴 +72</sub> | 634 | 634 |
...
| **read-source-map** | 308 <sub>🟢 -9</sub> | 317 | 317 <sub>🔴 +67</sub> | 250 | 250 |
