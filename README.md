...
| Prompt | Cost | **0.22.0** | **0.22.0** | **0.21.1** | **0.21.0** | **0.20.0** |
|---|---|---|---|---|---|---|
| **bump-semver-version** | $$$ | 422 | 422 <sub>🔴 +1</sub> | 421 | 421 | 421 |
| **commit** | $$ | 324 | 324 <sub>🟢 -1</sub> | 325 | 325 | 325 |
| **create-mr** | $$ | 272 | 272 | 272 | 272 | 272 |
| **create-pr** | $$$ | 403 | 403 | 403 | 403 | 403 |
| **create-simple-source-map** |  | - | - | 332 | 332 | 332 |
| **create-source-map** | $$ | 332 | 332 | - | - | - |
| **debug** | $$ | 317 | 317 | 317 | 317 | 317 |
| **fix-mr** | $$ | 202 | 202 | 202 | 202 | 202 |
| **fix-pr** | $$ | 275 | 275 | 275 | 275 | 275 |
| **improve-prompt** | $$ | 350 | 350 <sub>🟢 -2</sub> | 352 | 352 | 352 |
| **optimize-prompt** | $$$$$$ | 1172 | 1172 <sub>🔴 +150</sub> | 1022 | 1022 | 1022 |
| **plan-shipping** | $$ | 371 | 371 | 371 | 371 | - |
| **read-source-map** | $$ | 306 | 306 <sub>🟢 -2</sub> | 308 | 308 | 308 |
| **review-mr** | $$ | 228 | 228 | 228 | 228 | 228 |
| **review-pr** | $$ | 281 | 281 <sub>🟢 -1</sub> | 282 | 282 | 282 |
| **ship-gh-issue** | $$$ | 455 | 455 | - | - | - |
| **ship** | $$ | 244 | 244 <sub>🟢 -225</sub> | 469 | 469 <sub>🔴 +267</sub> | 202 |
| **squash** | $ | 180 | 180 | 180 | 180 | 180 |
| **suggest-better-function-names** | $$ | 303 | 303 | 303 | 303 | 303 |
| **TOTAL** |  | **6437** | **6437** <sub>🔴 +375</sub> | **6062** | **6062** <sub>🔴 +638</sub> | **5424** |
